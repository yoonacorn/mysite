	...
	<div class="site-content">
		...
		<section class="projects" id="content">
				<div class="project-1 project-item">
					...
					<a href="<?php echo $project_1_link; ?>"><?php if($project_1_img) {echo wp_get_attachment_image( $project_1_img, $size );}?></a>
				...
				<div class="project-5 project-item">
					...
					<a href="<?php echo $project_5_link; ?>"><?php if($project_5_img) {echo wp_get_attachment_image( $project_5_img, $size );}?></a>
					<p><?php echo $project_5_description; ?></p>
				</div>

				<div class="project-6 project-item">
					<h4><?php echo $project_6; ?></h4>
					<a href="<?php echo $project_6_link; ?>"><?php if($project_6_img) {echo wp_get_attachment_image( $project_6_img, $size );}?></a>
